...
class AgendasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create agenda" do
    assert_difference('Agenda.count') do
      post agendas_url, params: { agenda: { monitorium_id: @agenda.monitorium_id, user_id: @agenda.user_id } }
    end
  ...
  test "should update agenda" do
    patch agenda_url(@agenda), params: { agenda: { monitorium_id: @agenda.monitorium_id, user_id: @agenda.user_id } }
